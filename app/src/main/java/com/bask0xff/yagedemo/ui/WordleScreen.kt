...
class WordleScreen(name: String, private val gameLogic: GameLogic) :
    ...
    override fun OnTouch(x: Float, y: Float) {
        ...
        Log.d(TAG, "OnTouch: ${x.toInt()}, ${y.toInt()}")
    }
    ...
    override fun Render(frames: Int, canvas: Canvas?) {
        ...
        canvas?.drawText("ANIMATION: $frames ${gameLogic.width()} x ${gameLogic.height()}", ((50f + Math.random()*0f-10f).toFloat()), ((150f + Math.random()*0f-10f).toFloat()), paint);
